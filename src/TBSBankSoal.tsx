...
/* ============================================================
   ...
   Soal orisinal, disusun mengikuti format resmi LPDP:
...
const QUESTION_BANK = [
  ...
  },
  {
    ...
    type: "Silogisme",
    prompt:
      "Jika Ali rajin belajar DAN konsisten mengikuti simulasi tes bakat skolastik, maka ia akan menjadi awardee LPDP. Ali tidak menjadi awardee LPDP. Simpulan yang tepat adalah…",
    options: [
  ...
  // ---- Dari e-book "Latihan Soal & Pembahasan Soal TBS LPDP" (Try Out Seri 2) ----
  {
    id: "kl2_v1",
    cat: "verbal",
    type: "Sinonim",
  ...
  },
  {
    ...
    type: "Silogisme",
    prompt:
      "Jika peserta LPDP memiliki kemampuan penalaran numerik yang baik maka ia akan mendapatkan skor TBS tinggi. Jika peserta mendapatkan skor TBS tinggi maka ia berpeluang besar lolos seleksi substansi. Kesimpulan yang tepat adalah …",
    options: [
      ...
      "Jika tidak memiliki kemampuan numerik maka pasti gagal LPDP",
  ...
  // ---- Pemecahan Masalah tambahan dari e-book "Latihan Soal & Pembahasan Soal TBS LPDP" (Seri 2) ----
  {
    id: "kl2_m1",
    cat: "masalah",
    type: "Analisis Data",
  ...
  // ---- Soal cerita terverifikasi dari rekonstruksi awardee LPDP Batch 2 2023 ----
  {
    id: "aw23_1",
    cat: "kuantitatif",
    type: "Aritmetika",
...
export default function TBSBankSoal() {
  ...
  const lpdpPoints = correctCount * 5;
  ...
  return (
    <div style={styles.homeWrap}>
      <div style={styles.homeHeader}>
        <div style={styles.kicker}>SIMULASI TBS LPDP</div>
    ...
    <div style={styles.resultWrap}>
      <div style={styles.resultHeader}>
        ...
        <div style={styles.pointsNote}>
          Estimasi poin skema LPDP: <strong>{lpdpPoints}</strong> poin (5 poin/soal benar)
        </div>
